...
echo $EXECUTABLE_NAME_BASE
#LIBFUZZER_SRC=${LIBFUZZER_SRC:-$(dirname $(dirname $SCRIPT_DIR))/Fuzzer}
LIBFUZZER_SRC=${LIBFUZZER_SRC:-/root/Rlfuzz-peach/libfuzzer-workshop/libFuzzer/Fuzzer}
STANDALONE_TARGET=0
#AFL_SRC=${AFL_SRC:-$(dirname $(dirname $SCRIPT_DIR))/AFL}
AFL_SRC=${AFL_SRC:-/root/Rlfuzz-peach/rlfuzz/mods/afl-2.57b-mod/afl-2.57b}
