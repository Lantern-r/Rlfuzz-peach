                ...
                if _process is None:
                    ...
                    if 'EXTERNAL_AFL_FORKSERVER' not in env:
                        ...
                        if self.suffix is None:
                            ...
                            fd, afl_out_file = tempfile.mkstemp(suffix=self.suffix)
                        os.close(fd)
                        ...
                        t1 = threading.Thread(target=get_popen_output, args=(_process,))
                        t1.start()
