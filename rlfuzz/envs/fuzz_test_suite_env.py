...
class FuzzboringsslEnv(FuzzBaseEnv):
    def __init__(self):
        self._name = "boringssl"
        self._target_path = rlfuzz.boringssl_target_path()
        self._args = []
        ...
        super(FuzzboringsslEnv, self).__init__()
    ...
    def set_seed(self, seed_path):
        if os.path.isfile(seed_path):
            ...
            for each in self.seed_names:
                if each.endswith(self._suffix) or self._suffix == '':
