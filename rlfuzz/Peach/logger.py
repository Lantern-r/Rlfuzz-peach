...
from rlfuzz.Peach.Engine.engine import EngineWatcher
from rlfuzz.Peach.Engine.engine import Engine
from rlfuzz.Peach.Utilities.common import *
...
try:
    class FuzzManager(Logger):
        ...
        def OnFault(self, run, test, variationCount, monitorData, actionValues):
            ...
            # Collect |actionValues| crash information from rlfuzz.Peach.
            for i in range(len(actionValues)):
                if len(actionValues[i]) > 2:
            ...
            # Collect |monitorData| crash information from rlfuzz.Peach.
